"""
AI Agent Security - Multi-Step Tool Attacks  ·  attack.py (v18, MULTI-MESSAGE breakthrough)
==================================================================================
...
# The BINDING constraint is the PRIVATE cell: its provenance guardrail BLOCKS http.post and a
# blocked call burns extra compute (8-hop retries) -> measured ~1.91x slower/msg than public
# (memory: allow 23.9s/cand vs deny-all 45.6s/cand). A private-cell timeout zeroes the PUBLIC
# cells too (all-or-nothing), so we size the whole grid to the SLOW private cell.
PRIVATE_FACTOR = 2.2            # L_private / L_public margin (>=1.91 measured + headroom)
