...
# Validator measured terse+16-msg chains at ~1.5s/post steady-state (low variance).
# Assume 2.0s (conservative vs measured 1.5) so the returned list fits 9000s with margin
# even under latency spikes; the end-to-end validation confirms it before submission.
ASSUMED_REPLAY_LAT_S = 2.0
REPLAY_SAFE = 0.65
PROBE_MSGS = 3
GEN_MARGIN_S = 300.0
FALLBACK_N = 16
