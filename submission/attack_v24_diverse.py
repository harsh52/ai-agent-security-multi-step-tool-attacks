"""
AI Agent Security - Multi-Step Tool Attacks  ·  attack.py (v24, PRIVATE-DIVERSITY: exfil + CONFUSED_DEPUTY families)
==================================================================================
...
DIVERSE_FRACTION = 0.20   # ~1 in 5 candidates is a deputy (2nd family); keep exfil the majority
